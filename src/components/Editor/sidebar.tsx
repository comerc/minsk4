  ...
  return (Editor) => {
    ...
    class Sidebar extends React.Component {
      ...
      renderSidebar = () => {
        ...
        return (
          <div className="ce-toolbar" style={{ transform: 'translate3d(0px, 0px, 0px)' }}>
            <div className="ce-toolbar__content">
              <div
                className="ce-toolbar__plus ce-toolbar__plus--hidden"
                style={{ transform: 'translate3d(0px, calc(34px - 50%), 0px)' }}
              >
                {/* <svg class="icon icon--plus" width="14px" height="14px"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#plus"></use></svg> */}
              </div>
              <div
                className="ce-toolbox"
                style={{ transform: 'translate3d(0px, calc(34px - 50%), 0px)' }}
              >
