...
class Toolbar extends React.Component<any> {
  ...
  render() {
    ...
    const isEmptyParagraph = focusBlock && focusBlock.type === 'paragraph' && focusBlock.text === ''
      ...
      <div className={className}>
        ...
        >
          ...
          <div className="ce-toolbar__content">
            <Button
              className={classNames('ce-toolbar__plus', {
            ...
            <div className={classNames('ce-toolbox', { 'ce-toolbox--opened': isEmptyParagraph })}>
              <ul>
                <li>
                  <Button tool="header" theme={theme}>
                    123
                  </Button>
                </li>
